...
const dummyCartItems = [
    ...
    { id: 2, name: 'Boneka Teddy Bear', details: 'Coklat / 250 gram / x1', price: 250000, image: productImage },
];
                ...
                <HeaderContent $isScrolled={isScrolled} $isSearchOpen={isSearchOpen}>
                    ...
                    <ActionsContainer>
                        ...
                        <CartContainer>
                            ...
                            <CartPopup>
                                <CartHeader>Keranjang Belanja ({String(dummyCartItems.length).padStart(2, '0')})</CartHeader>
                                <CartItemList>
                                    {dummyCartItems.map(item => (
                                        <CartItem key={item.id}>
                                            ...
                                            <RemoveItemButton><CloseIcon /></RemoveItemButton>
                                        </CartItem>
                                    ))}
                                </CartItemList>
                                <CartFooter>
                                    ...
                                    <CartButtons>
                                        <PrimaryButton to="#">BELI SEKARANG →</PrimaryButton>
                                        <SecondaryButton to="#">LIHAT KERANJANG</SecondaryButton>
                                    </CartButtons>
                                </CartFooter>
                            </CartPopup>
                        </CartContainer>
