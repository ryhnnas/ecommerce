        ...
        <div style={styles.formGrid}>
            <div>
                <div style={styles.formGroup}>
                    ...
                    <input type="text" id="title" name="title" value={data.title} onChange={handleChange} style={styles.input} maxLength="60" />
                    <div style={styles.charCounter}>{data.title.length}/60</div>
                </div>
                <div style={styles.formGroup}>
            ...
            <div>
                <div style={styles.formGroup}>
                    ...
                    <input type="number" id="units" name="units" value={data.units} placeholder="Availability" onChange={handleChange} style={{ ...styles.input, ...styles.inputMuted }} />
                </div>
                <div style={styles.formGroup}>
...
const PhotosStep = ({ photos, onBack, onNext }) => (
    <div style={styles.card}>
        <div style={styles.cardTitle}>Add product photos (max 10)</div>
        <div style={styles.photoGrid}>
            ...
            {photos.map(photo => (
                <div key={photo.id} style={styles.photoThumbnail}>
                    <img src={photo.url} alt={photo.name} style={styles.photoImg} />
                    <div style={styles.photoOverlay}>
                        <div>{photo.name}</div>
                        <div>{photo.size}</div>
                        {photo.loading && <div style={{ width: `${photo.loading}%`, ...styles.progressBar }}></div>}
                    </div>
...
const AddProduct = () => {
    ...
    const [formData, setFormData] = useState({
        title: 'Graphic card GIGABYTE GeForce RTX 3050',
        description: 'The NVIDIA RTX 3050 graphics card is a design equipped with 8GB of GDDR6 memory...',
        units: '',
        length: 0, width: 0, height: 0,
        price: '',
        photos: [
            { id: 1, name: 'karta graficzna1.jpg', size: '24 Mb', url: 'https://images.tokopedia.net/img/cache/700/VqbcmM/2022/10/21/f217865c-310e-4364-8557-735952136e2f.jpg' },
            { id: 2, name: 'karta graficzna2.jpg', size: '24 Mb', url: 'https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//97/MTA-40342939/gigabyte_gigabyte_geforce_rtx_3050_gaming_oc_8g_-_vga_nvidia_pci_e_4-0_full01_gkm4k36w.jpg' },
            { id: 3, name: 'karta graficzna3.jpg', size: '24 Mb', url: 'https://images.tokopedia.net/img/cache/700/hDjmkQ/2023/12/29/73a5a4ba-3965-4d7a-8d76-d922a9acb2e5.jpg' },
            { id: 4, name: 'karta graficzna4.jpg', size: '24 Mb', url: 'https://down-id.img.susercontent.com/file/id-11134207-7r98r-lmuq4p37e0c283', loading: 87 },
        ],
    ...
    const renderStep = () => {
        switch (currentStep) {
            ...
            case 2:
                return <PhotosStep photos={formData.photos} onBack={handleBack} onNext={handleNext} />;
            case 3:
                return <ShippingStep data={formData} handleDeliveryChange={handleDeliveryChange} handleChange={handleChange} onBack={handleBack} onNext={handleNext} />;
            case 4:
                return <SuccessStep />;
            default:
                return null;
