...
const EmailIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
    <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2zm13 2.383-4.758 2.855L15 11.114V6.383zM1 6.383l4.758 2.855L1 11.114V6.383zM1.5 12.5l5.5-3.3L8 9.8l1-1.6 5.5 3.3H1.5z"/>
  </svg>
);
...
const FacebookIcon = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
    <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.375h-1.864v5.625C13.074 15.396 16 12.067 16 8.049z"/>
  </svg>
);
...
const Footer = () => {
  ...
  const styles = {
    footer: {
      ...
      color: 'white',
      fontFamily: "'Roboto', sans-serif", // Font dasar
    },
    // Bagian Atas Footer
    mainContent: {
      display: 'flex',
    ...
    // Kolom Tengah: Updates
    updatesColumn: {
        textAlign: 'center',
    },
    monospaceFont: {
        fontFamily: "'Courier New', Courier, monospace", // Font Monospace
    },
    sectionTitle: {
        fontSize: '2rem',
        fontWeight: 'bold',
    ...
    // Bagian Bawah Footer
    subFooter: {
      backgroundColor: '#002171', // Biru lebih gelap
      display: 'flex',
      justifyContent: 'space-between',
      alignItems: 'center',
      maxWidth: '1200px',
  ...
  // Menggabungkan style untuk elemen yang butuh font monospace
  ...
  return (
    <footer style={styles.footer}>
      ...
      <div style={styles.mainContent}>
        ...
        {/* Kolom 2: Get Updates */}
        <div style={{...styles.column, ...styles.updatesColumn}}>
        ...
        {/* Kolom 3: Kontak */}
        <div style={{...styles.column, ...styles.contactColumn}}>
          <a href="#" style={styles.contactLink}>Send Us A Message →</a>
