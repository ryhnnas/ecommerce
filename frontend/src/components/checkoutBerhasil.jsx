...
import checkCircleImage from '../assets/CheckCircle.png';
...
const CheckoutSuccess = () => {
  ...
  return (
    <div style={styles.container}>
      ...
      <h1 style={styles.title}>Pesanan anda berhasil dilakukan</h1>
      <p style={styles.subtitle}>Pesanan kamu berhasil dilakukan</p>
      ...
      <div style={styles.buttonContainer}>
        ...
        <Link to="/dashboard" style={{ ...styles.button, ...styles.primaryButton }}>
